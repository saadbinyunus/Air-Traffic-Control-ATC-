...
class FlightServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetLiveFlights = channel.unary_unary(
                '/FlightService/GetLiveFlights',
...
class FlightServiceServicer(object):
    ...
    def GetLiveFlights(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_FlightServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetLiveFlights': grpc.unary_unary_rpc_method_handler(
                    servicer.GetLiveFlights,
